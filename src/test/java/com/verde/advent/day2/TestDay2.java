...
public class TestDay2 {
    ...
    public void testPart1() {
        int[][] inputs = { { 5, 1, 9, 5}, {7, 5, 3}, {2, 4, 6, 8} };
        int expected = 18;
        
        assertEquals("part1", expected, Day2.compute1(inputs));

        int result = Day2.compute1(TEST);
        System.out.println("Part1: " + result);
    }

    @Test
    public void testPart2() {
        int[][] inputs = { { 5, 9, 2, 8}, {9, 4, 7, 3}, {3, 8, 6, 5} };
        int expected = 9;
        
        assertEquals("part2", expected, Day2.compute2(inputs));

        int result = Day2.compute2(TEST);
