...
public class Y2019D01 {
    /**
     * Compute the amount of fuel required to transport a mass.
     * 
     * @param mass the mass
     * @return the amount of fuel required to transport the mass
     */
    public static int computeRequiredFuel(int mass) {
        return (mass / 3) - 2;
    }
    
    /**
     * Compute the total amount of fuel required to transport a mass,
     * including a recursive accounting for the amount of fuel 
     * to transport the fuel itself.
     * 
     * @param mass the mass
     * @return the total amount of fuel required to transport the mass
     */
    public static int computeAllRequiredFuel(int mass) {
        int fuelForMass = computeRequiredFuel(mass);
        
        // Bottom out on recursion
        return
                (fuelForMass <= 0)
                ? 0
                : fuelForMass + computeAllRequiredFuel(fuelForMass);
    }
}
